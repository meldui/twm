defmodule Twm.ClassGroupConflictsTest do
  ...
  describe "merges classes from same group correctly" do
    ...
    test "multiple overflow-x classes" do
      assert Twm.merge("overflow-x-auto overflow-x-hidden overflow-x-scroll") == "overflow-x-scroll"
    end
    ...
    test "hover overflow-x conflicts with hover overflow-x" do
      assert Twm.merge("overflow-x-auto hover:overflow-x-hidden hover:overflow-x-auto overflow-x-scroll") == 
